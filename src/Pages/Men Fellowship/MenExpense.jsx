...
export const MenExpense = () => {
  ...
  // Fetch Men Fellowship expenses
  const fetchExpenses = async () => {
    try {
      const res = await axios.get(`${URL}/menfellow-expenses`, {
    ...
    <>
      <div className="p-3 mx-1 mt-3 bg-white shadow-md rounded-[10px]">
        <div className="flex items-center justify-between p-4">
          <h1 className="text-lg font-semibold">Men Fellowship Expense</h1>
          <div className="">
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center w-full h-full">
                ...
                <div className="relative w-full max-w-md max-h-full p-4 z-50">
                  <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <button type="button" onClick={() => setIsStatusModalOpen(false)} className="absolute top-3 end-2.5 text-[#DB7B7B] bg-transparent hover:bg-gray-200 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">✕</button>
                    <div className="p-4 text-center md:p-5">
                      ...
                      <button
                        onClick={async () => {
                          try {
                            await axios.put(`${URL}/menfellow-expenses/${selectedExpense._id}`, { approval_status: statusAction }, { headers: { Authorization: token } });
