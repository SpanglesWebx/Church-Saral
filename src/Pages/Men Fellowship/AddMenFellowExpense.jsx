...
export const AddMenFellowExpense = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      await axios.post(`${URL}/menfellow-expenses/add`, payload, { headers: { Authorization: token } });
  ...
  const handlePayExpense = async (expenseId, formData) => {
    try {
      const res = await axios.put(`${URL}/menfellow-expenses/pay/${expenseId}`, formData, {
        headers: { Authorization: token },
      });
