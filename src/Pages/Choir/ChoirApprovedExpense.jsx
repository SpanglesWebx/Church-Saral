...
export const ChoirApprovedExpense = () => {
    ...
    <>
      <div className="p-3 mx-1 mt-3 bg-white shadow-md rounded-[10px]">
        <div className="flex items-center justify-between p-4">
          <h1 className="text-lg font-semibold">Approved Expenses - Choir</h1>

          {/* Search */}
          <div>
            <label htmlFor="default-search" className="sr-only">Search Expenses</label>
            ...
            <tbody>
              {expenses.length > 0 ? expenses.map((exp, index) => (
                <tr key={exp._id} className="border-t">
                  ...
                  <td className="p-2 text-center">
                    <FaEye title='View' size={18} className="text-blue-600 cursor-pointer" onClick={() => { setSelectedExpense(exp); setIsModalOpen(true); }} />
                  </td>
                </tr>
              )) : (
                <tr>
