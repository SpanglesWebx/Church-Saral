...
export const ChurchAdminDash = () => {
  ...
  const fetchFamilyCount = async () => {
    const res = await axios.get(`${URL}/dashboard/churchadmin/family-count`, {
      headers: {
        Authorization: token,
      },
    });
  ...
  const fetchMemberCount = async () => {
    const res = await axios.get(`${URL}/dashboard/churchadmin/member-count`, {
    ...
    <div className="p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        ...
        <StatsCard
          ...
          icon={<FaPeopleRoof size={42} color="#8aaee0" />}
          loading={isLoading}
        />
