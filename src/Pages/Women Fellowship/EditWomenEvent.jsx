  ...
  useEffect(() => {
    ...
    const fetchEvent = async () => {
      ...
      try {
        ...
        setCompetitions(
          event.womenCompetitions?.length
            ? event.womenCompetitions
            : [{ competition: "", title: "", participants: [] }]
        );

        const tags = [
          ...new Set(
            (event.womenCompetitions || []).map(c => c.competition)
          )
        ];
