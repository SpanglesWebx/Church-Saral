...
export const Dashendschool = () => {
    ...
    const fetchDashboard = async () => {
        try {
            ...
            const res = await axios.get(`${URL}/dashboard/endeavour`, {
                headers: {
                    Authorization: token
                }
            });
            ...
            <div className="grid lg:grid-cols-3 gap-4 mt-6">
                ...
                <div className="bg-white rounded-2xl shadow-sm p-5 border-2 border-lavender--600">
                    ...
                    <div className="grid gap-2">
                        ...
                        <button
                            onClick={() => navigate("/admin/classend")}
                        ...
                        <button
                            onClick={() => navigate("/admin/teacherend")}
                        ...
                        <button
                            onClick={() => navigate("/admin/studentend")}
                            className="flex items-center justify-center gap-2 border border-gray-300 hover:bg-gray-100 py-2 rounded-lg text-sm"
                        >
                            <FaUsers /> Add Student
                        </button>
                        ...
                        <button
                            onClick={() => navigate("/admin/eventend")}
                            className="flex items-center justify-center gap-2 border border-gray-300 hover:bg-gray-100 py-2 rounded-lg text-sm"
                        >
