  ...
  const fetchBirthdayData = async () => {
    try {
      const params = {
        ...
        search: searchTerm || undefined, // Optional search term
...
console.log(response.data.BirthDayReminder);
  ...
  }, [activeTab, currentPage, dateRange, dayFilter, searchTerm]);
  ...
  return (
    <div className="relative h-full ml-5 w-[100%] bg-gray-100">
      <div className="p-6 bg-white rounded-lg shadow-lg">
        ...
        {/* Tabs */}
        <div className="flex justify-center">{renderTabs()}</div>
        <br />
