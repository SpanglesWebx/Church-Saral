...
return fetchData();
  ...
  const handleDownloadExcel = async () => {
    try {
      ...
      // Title row
      const titleRow = worksheet.addRow(["Marriage Reports"]);
      ...
      saveAs(blob, "MarriageReports.xlsx");
          ...
          <table className="min-w-full bg-white">
            ...
            <tbody>
              {currentPageData.map((item, index) => (
                ...
                >
                  <td className="px-4 text-sm py-2 text-center">{offset + index + 1}</td>
                  <td className="px-4 text-sm py-2 text-center">{item.member_id}</td>
                  {!showTamilOnly && (
                    <td className="px-4 py-4 text-sm">{item.member_name}</td>
                  )}
                  <td className="px-4 text-sm py-2">{item.member_tamil_name}</td>
                  <td className="px-4 text-sm py-2 text-center">
