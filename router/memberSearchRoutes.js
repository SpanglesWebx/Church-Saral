...
const { searchMembers, searchMembersById, searchMembersUnified, searchMaleMembers, searchMaleMembersById, 
    searchFemaleMembers, searchFemaleMembersById, searchMarriedHusbands, getSpouse, searchMenFellowshipByName,
    searchMenFellowshipById, searchWomenFellowshipByName, searchWomenFellowshipById, searchYouthFellowshipByName, 
    searchYouthFellowshipById, searchTeacherById, searchTeacherByName,searchChoirMemberById,
  searchChoirMemberByName, searchChoirMemberByMobile } = require("../controllers/memberSearchController");
...
// 🔍 Choir search routes
router.get("/choir-by-id", searchChoirMemberById);
router.get("/choir-by-name", searchChoirMemberByName);
router.get("/choir-by-mobile", searchChoirMemberByMobile);
